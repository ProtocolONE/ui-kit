...
## [1.25.4] - 2019-07-10
- Fix error block's position

## [1.25.2] - 2019-05-13
- Add corner for TagInput

## [1.25.1] - 2019-05-13
- Add clearing on blur for text field of TagInput

## [1.25.0] - 2019-05-12
- Add position for UiTip

## [1.24.1] - 2019-04-18
- Remove text-decoration from link inside PageHeader

## [1.24.0] - 2019-04-08
- Fix padding for side-footer from UiFormByStep
- Add v-model for UiCheckbox

## [1.23.1] - 2019-03-31
- Add styles for printed to UiTextarea

## [1.23.0] - 2019-03-31
- Add slot for left part in UiPaginator

## [1.22.0] - 2019-03-27
- Fix UiModal padding
- Add possible remove padding fron UiTip

## [1.21.1] - 2019-03-27
- Fix UiModal events bubbling

## [1.21.0] - 2019-03-26
- Add error text for UiTextarea
...
## [1.18.0] - 2019-03-20
- FormByStep contents fixes + new option - contentsHasPadding
- Extra option isClickable for UiTableRow

## [1.17.1] - 2019-03-18
- Fix default margin-bottom for SwitchBox component

## [1.17.0] - 2019-03-18
- Add color and type styles for Button
